    ...
    return (
      <section className={`${style.similarproducts} pb-5`}>
        <div className="container">
          <div className={`${style.row} row flex-row g-3 flex-nowrap overflow-x-auto`}>
            {recentProduct.map((product) => (
              <div className="col-sm-4 col-md-3 mb-3" key={product.id}>
                <div className={`${style.product} d-flex justify-content-center align-items-center flex-column gap-2 border px-3 py-3 rounded-3`}>
                  ...
                  <div className={`${style.info} w-100`}>
                    ...
                    {product.rating && (
                      <div className="rating">
                        <div className="rate d-flex justify-content-between align-items-center font-sm">
